...
void manage_dex(string, string, int, Pokedex&, ofstream&);
void search_by_dex(Pokedex, string, int, ofstream&);
void print_dex(int, int, Pokedex, ofstream&);
void search_by_dex_to_file(Pokedex, ofstream&, int);
void search_by_name(Pokedex, string, int, ofstream&);
void print_name(int, string, Pokedex, ofstream&);
void search_by_type(Pokedex, string, int, ofstream&);
void print_search_by_type(int, string, Pokedex, ofstream&);
void add_pokemon(string, Pokedex&, string, int);
